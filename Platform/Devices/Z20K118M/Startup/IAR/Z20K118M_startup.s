...
; @brief     : Z20K118M startup and Vector Table Source File for IAR.
; @version   : V1.8.0
; @date      : May-2020
...
__vector_table
        ...
        DCD   I2C1_IRQHandler            ; irq 6 : I2C 1 IRQHandler
        DCD   SPI0_IRQHandler            ; irq 7 : SPI 0 IRQHandler
        DCD   SPI1_IRQHandler            ; irq 8 : SPI 1 IRQHandler
        DCD   SPI2_IRQHandler            ; irq 9 : SPI 2 IRQHandler
        ...
        DCD   UART3_IRQHandler           ; irq 13 : UART3 IRQHandler
        ...
        DCD   CAN1_IRQHandler            ; irq 21 : CAN 1 IRQHandler
