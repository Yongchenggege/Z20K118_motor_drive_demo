...
/**
 * @file      : Z20K118M.h
 * @brief     : Z20K118M device header file.
 * @version   : V1.8.0
 * @date      : May-2020
 ...
 */
#define CAN_INSTANCE_NUM      (2U)
#define SPI_INSTANCE_NUM      (3U)
#define I2C_INSTANCE_NUM      (2U)
#define UART_INSTANCE_NUM     (4U)
...
#define SRAML_BASE_ADDR            ((uint32_t)0x1FFFC000)            /*!< SRAML base address */
#define SRAMU_BASE_ADDR            ((uint32_t)0x20000000)            /*!< SRAMU0(SRAM_U) base address */
...
#define CAN1_BASE_ADDR             (PERIPHERAL_BASE_ADDR + 0x2A000UL)       /*!< CAN1 base address */
...
#define SPI2_BASE_ADDR             (PERIPHERAL_BASE_ADDR + 0x2E000UL)       /*!< SPI2 base address */
...
#define I2C1_BASE_ADDR             (PERIPHERAL_BASE_ADDR + 0x67000UL)       /*!< I2C1 base address */
...
#define UART3_BASE_ADDR            (PERIPHERAL_BASE_ADDR + 0x6D000UL)       /*!< UART3 base address */
